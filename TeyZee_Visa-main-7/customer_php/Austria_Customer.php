...
<head>
    ...
    <title>Austria Visa Checklist</title>
...
<body>
    ...
    <div class="tab-container">
        ...
        <div id="tourist" class="tabcontent active">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        Passport:<br>
                        (a) Its validity shall extend at least three months after the intended date of departure from the territory of the Member States or, in the case of several visits, after the last intended date of departure from the territory of the Member States;<br>
                        (b) It shall contain at least two blank pages;<br>
                        (c) It shall have been issued within the previous 10 years;<br>
                        (d) NO alteration or handwritten amendment concerning the data page
                    </td>
                </tr>
                <tr>
                    <td>3</td>
                    <td>One photograph: shall be in accordance with the international standards as set out in the International Civil Aviation Organization (ICAO)</td>
                </tr>
                <tr>
                    <td>4</td>
                    <td>
                        Valid permit to return (if applicable), e.g., valid Indian Residency Permit or return visa to India for citizens of Bangladesh / Bhutan / India / Maldives / Nepal / Sri Lanka.<br>
                        For Tibetans travelling on Indian IC (yellow Identity Certificate) it is mandatory to hold a Return Visa (valid until at least three months after your intended return to India) and the stamped entry “No objection to return to India” (NORI) in the IC.
                    </td>
                </tr>
                <tr>
                    <td>5</td>
                    <td>
                        Documents for your trip:<br>
                        - Round-trip flight reservations - travel itinerary: airline reservation and proof of other means of travel within Austria/EU in case of onward travel<br>
                        - Proof of accommodation: hotel reservation / letter of tour organizer and/or other documentation indicating the envisaged travel plans within Austria / EU<br>
                        - Travel medical insurance valid throughout the territory of the Member States and covering the entire period of intended stay or transit, with minimum coverage of EUR 30,000.
                    </td>
                </tr>
                <tr>
                    <td>6</td>
                    <td>
                        Proof of occupation:<br>
                        - Employed: Last 3 months’ salary certificate, employment contract, and company NOC to leave. Mention official email address on the application or provide business card.<br>
                        - Self-employed: GST certificate/Udhyog Aadhar/Import Export Certificate/Certificate of Incorporation etc.<br>
                        - Retired: Pension statements for last 3 months and/or proof of regular income from property/business.<br>
                        - Student: Proof of enrollment/registration in school/college/university.
                    </td>
                </tr>
                <tr>
                    <td>7</td>
                    <td>
                        ...
                        - Original bank statements for the last 3 months and/or other proof of funds<br>
                        - ITR (with barcode) for the last 3 years
                    </td>
                </tr>
                <tr>
                    <td>8</td>
                    <td>
                        Minor travelers:<br>
                        - If accompanied by one parent: Original notarized NOC by the other parent, plus copies of parents' passports or ID<br>
                        - If travelling alone: Original notarized NOC by both parents/legal guardians, plus copies of parents' passports or ID
                    </td>
                </tr>
                <tr>
                    <td>9</td>
                    <td>
                        Passport:<br>
                        - Copy of present passport (data pages, visas, travel history)<br>
                        - Originals of previous passports or proof of loss
                    </td>
                </tr>
                <tr>
                    <td>10</td>
                    <td>Contact details of the applicant: Operational email address, mobile number, and business card.</td>
                </tr>
                <tr>
                    <td>11</td>
                    <td>
                        Notes:<br>
                        - For stays longer than 6 months, apply for Residence Permit (“Aufenthaltstitel”).<br>
                        - Visa “C” is valid up to 90 days; Visa “D” between 91 and 180 days.<br>
                        - Visa extensions or renewals are not possible in Austria.<br>
                        - Representative must provide an authorization letter and ID.<br>
                        - Applicant is responsible for submitted information.<br>
                        - Apply no earlier than 6 months and at least 1 month before travel.<br>
                        - Processing time: up to 15 working days, can extend up to 60 days.<br>
                        - Additional documents may be requested, and interviews may be required.<br>
                        - Submission of incomplete documentation can result in refusal.
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div id="business" class="tabcontent">
            <h2>Austria Business Visa Checklist</h2>
            <table>
                <tr>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>Check list of Schengen countries: Austria, Belgium, Czech Republic, Croatia, Denmark, Estonia,
                        ...
                        Luxembourg, Malta, Netherlands, Norway, Poland, Portugal, Slovakia, Slovenia, Spain, Austria, and
                        Switzerland.</td>
                </tr>
                <tr>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            downloadLinks.forEach(function (link) {
                link.addEventListener('click', function (e) {
                    ...
                    const message = `Kindly provide the latest ${templateName} for my visa application. In case you have not paid TeyZee Visa Fees, please make the visa service fees payment and get the receipt number. Link to Visa Fees Page for Austria- https://teyzee.com/France-visa-fees; please type the 7 digit receipt no in your next whatsapp message to us`;

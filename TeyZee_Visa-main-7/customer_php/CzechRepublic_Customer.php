...
<head>
    ...
    <title>Czech Republic Visa Checklist</title>
...
<body>
    ...
    <h1>Czech Republic Schengen Visa Checklist</h1>
    ...
    <div class="tab-container">
        ...
        <div id="tourist" class="tabcontent active">
            <h2>Czech Republic Tourist Visa Checklist </h2>
            <table>
                <tr>
                ...
                <tr>
                    <td>2</td>
                    <td>Valid passport that should 
                        <ul>
                            <li>Have been issued within the last 10 years</li>
                            <li>Be of validity exceeding by three months after the scheduled return</li>
                            <li>Include at least two empty pages</li>
                        </ul>
                    </td>
                </tr>
                <tr>
                    <td>3</td>
                    <td>Two recent (not older than six months) passport-size photo in color with white background and face of the applicant must cover at least 80% of the frame, according to the specifications laid down by ICAO</td>
                </tr>
                <tr>
                    <td>4</td>
                    <td>Proof of means of transport:
                        <ul>
                            <li>Flight reservation of return or round ticket</li>
                            <li>Proof of intra-Schengen flight reservation, train itinerary or car rental (if visiting multiple countries)</li>
                        </ul>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>Proof of lodging:
                        <ul>
                            <li>Hotel reservations, rental of holiday home or campus residence</li>
                            <li>If staying with a family member or friend: proof of sponsorship and/or private accommodation</li>
                            <li>May require a national form from Schengen State's authority</li>
                            <li>Proof of lodging in each country (if visiting multiple countries)</li>
                        </ul>
                    </td>
                </tr>
                <tr>
                    <td>6</td>
                    <td>Cover Letter signed by the applicant explaining the purpose of visit to the Czech Republic and entire travel plan (itinerary)</td>
                </tr>
                <tr>
                    <td>7</td>
                    <td>Business trips:
                        <ul>
                            <li>Invitation from the inviting company or organization</li>
                            <li>Cover letter from the applicant's employer confirming identity, purpose, period, and place of stay</li>
                        </ul>
                    </td>
                </tr>
                <tr>
                    <td>8</td>
                    <td>Travel medical insurance valid for all Schengen-countries covering at least 30,000 EUR (accident, illness, emergency, etc.), for full trip duration</td>
                </tr>
                <tr>
                    <td>9</td>
                    <td>Proof of financial means:
                        <ul>
                            <li>Original private bank statement (last 3 months), stamped and signed</li>
                            <li>Indian income tax return acknowledgment (last 2 years)</li>
                            <li>If employed: Pay slips (last 3 months), employment contract, holiday approval</li>
                            <li>If self-employed: Company registration certificate</li>
                            <li>If sponsored: National sponsorship form, proof of income or property ownership</li>
                            <li>If minor: Notarized parental consent (as applicable), passport/ID of parents, school/university enrollment</li>
                        </ul>
                    </td>
                </tr>
                <tr>
                    <td>10</td>
                    <td>Clear photocopy of first and last page of passport and at least two previous Schengen visas (if applicable)</td>
                </tr>
                <tr>
                    <td>11</td>
                    <td>Study, research, or internship:
                        <ul>
                            <li>Certificate of admission/registration or invitation letter</li>
                            <li>Student ID copy and supporting certificates</li>
                        </ul>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>Tourism:
                        <ul>
                            <li>Travel agency booking or travel plan proof</li>
                            <li>Marriage certificate (if not in passport), ration card copy if applicable</li>
                        </ul>
                    </td>
                </tr>
                <tr>
                    <td>13</td>
                    <td>Visiting family/friends:
                        <ul>
                            <li>Marriage certificate or ration card (if applicable)</li>
                            <li>Proof of family relationship if visiting relatives</li>
                        </ul>
                    </td>
                </tr>
                <tr>
                    <td>14</td>
                    <td>Cultural, sports, religious events, and film crews:
                        <ul>
                            <li>Invitation, tickets, enrollment/program details</li>
                            <li>Film crew: letter from company, crew list, permissions, registration certificate</li>
                        </ul>
                    </td>
                </tr>
                <tr>
                    <td>15</td>
                    <td>Official delegations:
                        <ul>
                            <li>Official invitation copy</li>
                            <li>Note verbale confirming applicant’s identity, purpose, duration, and stay details</li>
                        </ul>
                    </td>
                </tr>
                <tr>
                    <td>16</td>
                    <td>Same as above (official delegations)</td>
                </tr>
                <tr>
                    <td>17</td>
                    <td>Medical treatment:
                        <ul>
                            <li>Medical certificate from home country</li>
                            <li>Confirmation from receiving hospital in Czech Republic</li>
                            <li>Proof of treatment pre-payment</li>
                            <li>Relevant correspondence between doctors</li>
                        </ul>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>Airport transit:
                        <ul>
                            <li>Visa or entry permit for third country</li>
                            <li>Documents for onward journey</li>
                        </ul>
                    </td>
                </tr>
                <tr>
                    <td>19</td>
                    <td>All documents must be presented in the listed order in original. If keeping originals, provide A4 size copies. The Czech Embassy may request additional documents or interviews. Submission does not guarantee visa approval.</td>
                </tr>
            </table>
        </div>

        <div id="business" class="tabcontent">
            <h2>Czech Republic Business Visa Checklist</h2>
            <table>
                <tr>
        ...
        <div id="additional" class="tabcontent">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>Check list of Schengen countries: Czech Republic, Czech Republic, Czech Republic, Croatia, Denmark, Estonia,
                        Finland, France, Germany, Greece, Hungary, Iceland, Italy, Latvia, Liechtenstein, Lithuania,
                        Luxembourg, Malta, Netherlands, Norway, Poland, Portugal, Slovakia, Slovenia, Spain, Czech Republic, and
                        Switzerland.</td>
                </tr>
                <tr>
    ...
    <div class="note">
        <strong>Note:</strong><p style="text-align:justify; text-indent: 5%">Above information is compiled by TeyZee Visas team on a best effort basis. While every attempt is made for accuracy, we are not responsible for any errors or delayed updates.  Official link for checklist is as follows <a href="https://visa.vfsglobal.com/one-pager/czechrepublic/india/pdf/new-form.pdf">Click Here</a> </p> <br>
        <p style="text-align:justify; text-indent: 5%">This checklist is provided for informational purposes only. Requirements may change, so it's recommended to verify the current requirements with the Embassy of Czech Republic or consulate in your country before
        applying.</p>
    </div>
    <footer>
        <div class="container">
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            downloadLinks.forEach(function (link) {
                link.addEventListener('click', function (e) {
                    ...
                    const message = `Kindly provide the latest ${templateName} for my visa application. In case you have not paid TeyZee Visa Fees, please make the visa service fees payment and get the receipt number. Link to Visa Fees Page for Czech Republic- https://teyzee.com/France-visa-fees; please type the 7 digit receipt no in your next whatsapp message to us`;

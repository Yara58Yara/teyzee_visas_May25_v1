...
<head>
    ...
    <title>Estonia Visa Checklist</title>
...
<body>
    ...
    <h1>Estonia Schengen Visa Checklist</h1>
    ...
    <div class="tab-container">
        ...
        <div id="tourist" class="tabcontent active">
            <h2>Estonia Tourist Visa Checklist </h2>
            <table>
                <tr>
                ...
                <tr>
                    <td>3</td>
                    <td>One passport photograph – not older than 6 months (35mm x 45mm) in color with white background with no software corrections.</td>
                </tr>
                <tr>
                    <td>4</td>
                    <td>Travel health insurance - Valid in Schengen countries with a coverage of at least 30,000 EUR for the entire duration of stay in the Schengen area <br><a href="https://www.vfsglobal.com/estonia/india/pdf/Travel-Insurance-Companies-Family.pdf" target="_blank">Approved Insurance List</a></td>
                </tr>
                <tr>
                    <td>5</td>
                    <td>Proof of accommodation –<ul>
                        <li>Hotel reservations, rental of holiday home or campus residence reservation</li>
                        <li>If staying with a family member or friend, proof of sponsorship and/or private accommodation from the host</li>
                        <li>If travelling to several Member States, proof of accommodation in each</li>
                    </ul></td>
                </tr>
                <tr>
                    <td>6</td>
                    <td>Proof of means of transport – flight return tickets and itinerary (please do not buy tickets before obtaining the visa!)</td>
                </tr>
                <tr>
                    <td>7</td>
                    <td>Proof of financial means – <br>All documents must be ORIGINALS on A4 paper.<ul>
                        <li>Last 3 months personal bank statements (stamped & signed by the bank)</li>
                        <li>Personal ITR acknowledgment receipt for last 2 assessment years</li>
                        <li><strong>If employed:</strong> Last 3 months salary slips & salary account statements (stamped & signed)</li>
                        <li><strong>If self-employed:</strong> Business registration, 3 months personal & business account statements (stamped & signed)</li>
                        <li><strong>If retired:</strong> 3 months pension bank statement & proof of regular income from property or business</li>
                        <li><strong>If sponsored:</strong> 3 months sponsor bank statements, proof of work/business, and ITR receipts for last 2 years</li>
                    </ul></td>
                </tr>
                <tr>
                    <td>8</td>
                    <td>Children under 18 years old, not travelling with both parents:<ul>
                        <li>Consent letter from non-travelling parent/legal guardian notarized</li>
                        <li>If travelling alone: Consent letter from both parents/legal guardian notarized</li>
                        <li>Copies of passports of both parents or legal guardian</li>
                    </ul></td>
                </tr>
                <tr>
                    <td>9</td>
                    <td>Students - Copy of student college ID card and introduction letter from School/College/University</td>
                </tr>
                <tr>
                    <td>10</td>
                    <td>Certificate from travel agency confirming booking of organized trip or any other appropriate document indicating travel plans</td>
                </tr>
                <tr>
                    <td>11</td>
                    <td>Passport copy of 1st page (bio data) and last page of the passport</td>
                </tr>
            </table>
        </div>

        <div id="business" class="tabcontent">
            <h2>Estonia Business Visa Checklist</h2>
            <table>
                <tr>
        ...
        <div id="additional" class="tabcontent">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>Check list of Schengen countries: Estonia, Estonia, Estonia, Croatia, Estonia, Estonia,
                        Estonia, France, Germany, Greece, Hungary, Iceland, Italy, Latvia, Liechtenstein, Lithuania,
                        Luxembourg, Malta, Netherlands, Norway, Poland, Portugal, Slovakia, Slovenia, Spain, Estonia, and
                        Switzerland.</td>
                </tr>
                <tr>

...
<body>
    ...
    <h1>Finland Schengen Visa Checklist</h1>
    ...
    <div class="tab-container">
        ...
        <div id="tourist" class="tabcontent active">
            <h2>Finland Tourist Visa Checklist </h2>
            <table>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <ul>
                            ...
                            <li>Business Registration (For Proprietor – Company Registration & GST Certificate, For Partner - Partnership Deed, For Director - Memorandum of Association)</li>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <ul>
                            <li>Bonafide Certificate from school / university</li>
        ...
        <div id="business" class="tabcontent">
            <h2>Finland Business Visa Checklist</h2>
            <table>
                <tr>
        ...
        <div id="additional" class="tabcontent">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>Check list of Schengen countries: Finland, Finland, Finland, Croatia, Finland, Estonia,
                        Finland, France, Germany, Greece, Hungary, Iceland, Italy, Latvia, Liechtenstein, Lithuania,
                        Luxembourg, Malta, Netherlands, Norway, Poland, Portugal, Slovakia, Slovenia, Spain, Finland, and
                        Switzerland.</td>
                </tr>
                <tr>
    ...
    <div class="note">
        <strong>Note:</strong><p style="text-align:justify; text-indent: 5%">Above information is compiled by TeyZee Visas team on a best effort basis. While every attempt is made for accuracy, we are not responsible for any errors or delayed updates.  Official link for checklist is as follows <a href="https://um.fi/documents/35732/0/31800048_UM_Viisumilomake_Schengen_taytettava_EN_22_01_14.pdf/31c11098-37e4-f4e1-7f87-b03318aed5b3?t=1642762548291">Click Here</a> </p> <br>
        <p style="text-align:justify; text-indent: 5%">This checklist is provided for informational purposes only. Requirements may change, so it's recommended to verify the current requirements with the Embassy of Finland or consulate in your country before
        applying.</p>
    </div>
    <footer>
        <div class="container">
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            downloadLinks.forEach(function (link) {
                link.addEventListener('click', function (e) {
                    ...
                    const message = `Kindly provide the latest ${templateName} for my visa application. In case you have not paid TeyZee Visa Fees, please make the visa service fees payment and get the receipt number. Link to Visa Fees Page for Finland- https://teyzee.com/France-visa-fees; please type the 7 digit receipt no in your next whatsapp message to us`;

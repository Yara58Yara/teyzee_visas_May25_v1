...
<body>
    ...
    <div class="tab-container">
        ...
        <div id="tourist" class="tabcontent active">
            <h2>Lithuania Tourist Visa Checklist </h2>
            <table>
                <tr>
                ...
                <tr>
                    <td>2</td>
                    <td>
                        2 recent photograph each:<br>
                        • 35*45 mm size, white background, matt finished & 80% face image, without specs & not used in previous visa
                    </td>
                </tr>
                <tr>
                    <td>3</td>
                ...
                <tr>
                    <td>5</td>
                    <td>
                        If applicant is Self Employed:<br>
                        • Business letterhead with Sign & Stamp<br>
                        • Business Registration (For Proprietor – Company Registration & GST Certificate, For Partner - Partnership Deed, For Director - Memorandum of Association)<br>
                        • Last 03 years Income Tax Return Acknowledgement Page only<br>
                        • Last 06 months Updated Bank Statement with bank sign and stamp on each page
                    </td>
                </tr>
                <tr>
                    <td>6</td>
                    <td>
                        If applicant is Retired:<br>
                ...
                <tr>
                    ...
                    <td>
                        Note:<br>
                        • All Documents required in A4 Size Paper and English Only<br>
                        ...
                        • If Biometric is given after 2nd November 2015 then we can submit your Application on behalf of applicant. But if your data could not be fetched by Embassy / Consulate then they may ask to give biometrics again. (Biometric is Valid for 05 Years Only)<br>
                        ...
                        • No documents will be returned back by Embassy/Consulate after visa process.<br>
                        ...
                        • Please note that you may be required to come for a personal interview with the visa officer at the Embassy of the Lithuania prior to a decision being made on your application.
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div id="business" class="tabcontent">
            <h2>Lithuania Business Visa Checklist</h2>
            <table>
                <tr>
        ...
        <div id="additional" class="tabcontent">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>Check list of Schengen countries: Lithuania, Lithuania, Lithuania, Croatia, Lithuania, Lithuania,
                        Lithuania, France, Germany, Greece, Lithuania, Lithuania, Italy, Lithuania, Liechtenstein, Lithuania,
                        Luxembourg, Malta, Netherlands, Norway, Poland, Portugal, Slovakia, Slovenia, Spain, Lithuania, and
                        Switzerland.</td>
                </tr>
                <tr>
    ...
    <div class="note">
        <strong>Note:</strong><p style="text-align:justify; text-indent: 5%">Above information is compiled by TeyZee Visas team on a best effort basis. While every attempt is made for accuracy, we are not responsible for any errors or delayed updates.  Official link for checklist is as follows <a href="https://www.fas.usda.gov/sites/default/files/lithuania.pdf">Click Here</a> </p> <br>
        <p style="text-align:justify; text-indent: 5%">This checklist is provided for informational purposes only. Requirements may change, so it's recommended to verify the current requirements with the Embassy of Lithuania or consulate in your country before
        applying.</p>
    </div>
    <footer>
        <div class="container">
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            downloadLinks.forEach(function (link) {
                link.addEventListener('click', function (e) {
                    ...
                    const message = `Kindly provide the latest ${templateName} for my visa application. In case you have not paid TeyZee Visa Fees, please make the visa service fees payment and get the receipt number. Link to Visa Fees Page for Lithuania- https://teyzee.com/France-visa-fees; please type the 7 digit receipt no in your next whatsapp message to us`;

...
<head>
    ...
    <title>Malaysia Visa Checklist</title>
...
<body>
    ...
    <div class="tab-container">
        ...
        <div id="tourist" class="tabcontent active">
            <h2>Malaysia Tourist Visa Checklist</h2>
            <table>
                <tr>
        ...
        <div id="business" class="tabcontent">
            <h2>Malaysia Business Visa Checklist</h2>
            <table>
                <tr>
        ...
        <div id="additional" class="tabcontent">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>Check list of Schengen countries: Malaysia, Belgium, Czech Republic, Croatia, Denmark, Estonia,
                        Finland, France, Germany, Greece, Hungary, Iceland, Italy, Latvia, Liechtenstein, Lithuania,
                        Luxembourg, Malta, Netherlands, Norway, Poland, Portugal, Slovakia, Slovenia, Spain, Malaysia, and
                        Switzerland.</td>
                </tr>
                <tr>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            downloadLinks.forEach(function (link) {
                link.addEventListener('click', function (e) {
                    ...
                    const message = `Kindly provide the latest ${templateName} for my visa application. In case you have not paid TeyZee Visa Fees, please make the visa service fees payment and get the receipt number. Link to Visa Fees Page for Malaysia- https://teyzee.com/France-visa-fees; please type the 7 digit receipt no in your next whatsapp message to us`;

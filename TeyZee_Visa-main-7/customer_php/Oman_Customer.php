...
<head>
    ...
    <title>Oman Visa Checklist</title>
...
<body>
    ...
    <div class="tab-container">
        ...
        <div id="tourist" class="tabcontent active">
            <h2>Oman Tourist Visa Checklist</h2>
            <table>
                <tr>
          ...
          <tr>
            <td>• DOCUMENTS REQUIRED FOR ALL APPLICANTS</td>
          </tr>
          <tr>
            <td>1</td>
          ...
          <tr>
            <td colspan="2">• DOCUMENTS ACCORDING TO THE PERSONAL STATUS</td>
          </tr>
          <tr>
            <td>9</td>
            <td>
          ...
          <tr>
            <td colspan="2">• DOCUMENTS ACCORDING TO THE PURPOSE OF TRAVEL</td>
          </tr>
          <tr>
            <td>I</td>
            <td>
        ...
        <div id="business" class="tabcontent">
            <h2>Oman Business Visa Checklist</h2>
            <table>
                <tr>
        ...
        <div id="additional" class="tabcontent">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>Check list of Schengen countries: Oman, Belgium, Czech Republic, Croatia, Denmark, Estonia,
                        Finland, France, Germany, Greece, Hungary, Iceland, Italy, Latvia, Liechtenstein, Lithuania,
                        Luxembourg, Malta, Netherlands, Norway, Poland, Portugal, Slovakia, Slovenia, Spain, Oman, and
                        Switzerland.</td>
                </tr>
                <tr>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            downloadLinks.forEach(function (link) {
                link.addEventListener('click', function (e) {
                    ...
                    const message = `Kindly provide the latest ${templateName} for my visa application. In case you have not paid TeyZee Visa Fees, please make the visa service fees payment and get the receipt number. Link to Visa Fees Page for Oman- https://teyzee.com/France-visa-fees; please type the 7 digit receipt no in your next whatsapp message to us`;

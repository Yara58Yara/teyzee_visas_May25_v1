...
<head>
    ...
    <title>Romania Visa Checklist</title>
...
<body>
    ...
    <div class="tab-container">
        ...
        <div id="tourist" class="tabcontent active">
            <h2>Romania Tourist Visa Checklist</h2>
            <table>
                <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <ul>
                    <li>35*45 mm size, white background, matt finished & 80% face image</li>
        ...
        <tr>
            ...
            <td>
                ...
                <ul>
                    <li>Business letterhead with Sign & Stamp</li>
                    <li>Business Registration:
                        <ul>
                            <li>For Proprietor – Company Registration & GST Certificate</li>
                            <li>For Partner - Partnership Deed</li>
                            <li>For Director - Memorandum of Association</li>
                        </ul>
                    </li>
                    <li>Last 03 years Income Tax Return Acknowledgement Page only</li>
                    <li>Last 06 months Updated Bank Statement with bank sign and stamp on each page</li>
                </ul>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <ul>
                    ...
                    <li>Pension Payment Order OR Pension passbook</li>
                </ul>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <ul>
                    ...
                    <li>ID Card Copy of School / College</li>
                </ul>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <ul>
                    <li>Hotel Confirmation Voucher (From Supplier OR Directly from Hotel)</li>
        ...
        <tr>
            ...
            <td>
                ...
                <ul>
                    <li>Minimum coverage of 30,000 Euro per person</li>
                    <li>Insurance has to cover the entire stay in Schengen territory</li>
                    <li>Minimum 15 days insurance is mandatory from the travel date</li>
                </ul>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <ul>
                    ...
                    <li>Granting Visas is sole discretion of Consulates / Embassy, subject to the documents submitted. We are facilitators in the process. Best Voyage is not held responsible for rejection or delay in getting visas / passports from said Consulate / Embassy.</li>
                    <li>No documents will be return back by Embassy/Consulate after visa process.</li>
        ...
        <div id="business" class="tabcontent">
            <h2>Romania Business Visa Checklist</h2>
            <table>
                <tr>
        ...
        <div id="additional" class="tabcontent">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>Check list of Schengen countries: Romania, Belgium, Czech Republic, Croatia, Denmark, Estonia,
                        Finland, France, Germany, Greece, Hungary, Iceland, Italy, Latvia, Liechtenstein, Lithuania,
                        Luxembourg, Malta, Netherlands, Norway, Poland, Portugal, Slovakia, Slovenia, Spain, Romania, and
                        Switzerland.</td>
                </tr>
                <tr>
    ...
    <div class="note">
        <strong>Note:</strong><p style="text-align:justify; text-indent: 5%">Above information is compiled by TeyZee Visas team on a best effort basis. While every attempt is made for accuracy, we are not responsible for any errors or delayed updates.  Official link for checklist is as follows <a href="https://useteleport.com/blog/romania-tourist-visa">Click Here</a> </p> <br>
        <p style="text-align:justify; text-indent: 5%">This checklist is provided for informational purposes only. Requirements may change, so it's recommended to verify the current requirements with the Embassy of Romania or consulate in your country before
        applying.</p>
    </div>
    <footer>
        <div class="container">
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            downloadLinks.forEach(function (link) {
                link.addEventListener('click', function (e) {
                    ...
                    const message = `Kindly provide the latest ${templateName} for my visa application. In case you have not paid TeyZee Visa Fees, please make the visa service fees payment and get the receipt number. Link to Visa Fees Page for Romania- https://teyzee.com/France-visa-fees; please type the 7 digit receipt no in your next whatsapp message to us`;

...
<head>
    ...
    <title>Slovakia   Visa Checklist</title>
...
<body>
    ...
    <h1>Slovakia   Schengen Visa Checklist</h1>
    ...
    <div class="tab-container">
        ...
        <div id="tourist" class="tabcontent active">
            <h2>Slovakia   Tourist Visa Checklist </h2>
            <table>
                <tr>
                ...
                <tr>
                    <td>1</td>
                    <td>Visa application form duly completed and signed</td>
                </tr>
                <tr>
                    <td>2</td>
                    <td>Confirmation from the office of Labor of the Slovak Republic informing the possibility of filling a vacant job position.</td>
                </tr>
                <tr>
                    <td>3</td>
                    <td>Original contract/confirmation of employment from the Slovak company in Slovak Language (Prislub). In the contract/prislub, total of monthly salary should be clearly indicated.</td>
                </tr>
                <tr>
                    <td>4</td>
                    <td>
                        Original confirmation of accommodation in the Slovak language.<br>
                        *In the event the confirmation is issued by an individual, notarized confirmation and List Vlastnictva is required, however, if the confirmation is issued by the company, the signature of the authorized person and company stamp is sufficient.<br>
                        *(Confirmation of accommodation is not required for the applicant applying for the position of truck driver)
                    </td>
                </tr>
                <tr>
                    <td>5</td>
                    <td>
                        Original Criminal Record from the country of origin and Original Criminal record from the country where applicant has resided during last three years for the period longer than 90 days within six consecutive months.<br>
                        *Apostilled/super legalized and translated into Slovak/Czech language by the Slovak/Czech Official translator.
                    </td>
                </tr>
                <tr>
                    <td>6</td>
                    <td>Valid Passport - Valid for at least 6 months from the date of application with at least 2 blank pages</td>
                </tr>
                <tr>
                    <td>7</td>
                    <td>Certificate of competence/International license if any</td>
                </tr>
                <tr>
                    <td>8</td>
                    <td>Three (3) recent passport size photo (white background) taken within the last 6 months</td>
                </tr>
                <tr>
                    <td>9</td>
                    <td>Confirmed flight reservation (one way ticket)</td>
                </tr>
                <tr>
                    <td>10</td>
                    <td>Travel insurance valid for 90-92 days or higher</td>
                </tr>
                <tr>
                    <td>11</td>
                    <td>Copy of Government/National issued ID</td>
                </tr>
                <tr>
                    <td>12</td>
                    <td>Copy of valid resident permit for the foreigner living in Malaysia/Singapore/Indonesia/Philippines, Brunei Darrusalam</td>
                </tr>
            </table>
        </div>

        <div id="business" class="tabcontent">
            <h2>Slovakia   Business Visa Checklist</h2>
            <table>
                <tr>
        ...
        <div id="additional" class="tabcontent">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>Check list of Schengen countries: Slovakia  , Slovakia  , Slovakia  , Croatia, Slovakia  , Slovakia  ,
                        Slovakia  , France, Germany, Greece, Slovakia  , Slovakia  , Italy, Slovakia  , Liechtenstein, Slovakia  ,
                        Slovakia  , Slovakia  , Slovakia  , Slovakia  , Poland, Slovakia  , Slovakia, Slovakia , Spain, Slovakia  , and
                        Switzerland.</td>
                </tr>
                <tr>
    ...
    <div class="note">
        <strong>Note:</strong><p style="text-align:justify; text-indent: 5%">Above information is compiled by TeyZee Visas team on a best effort basis. While every attempt is made for accuracy, we are not responsible for any errors or delayed updates.  Official link for checklist is as follows <a href="https://blsslovakiavisa.com/india/assets/pdf/application_form/Visa_Application_From-Schengen.pdf">Click Here</a> </p> <br>
        <p style="text-align:justify; text-indent: 5%">This checklist is provided for informational purposes only. Requirements may change, so it's recommended to verify the current requirements with the Embassy of Slovakia or consulate in your country before
        applying.</p>
    </div>
    <footer>
        <div class="container">
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            downloadLinks.forEach(function (link) {
                link.addEventListener('click', function (e) {
                    ...
                    const message = `Kindly provide the latest ${templateName} for my visa application. In case you have not paid TeyZee Visa Fees, please make the visa service fees payment and get the receipt number. Link to Visa Fees Page for Slovakia  - https://teyzee.com/France-visa-fees; please type the 7 digit receipt no in your next whatsapp message to us`;

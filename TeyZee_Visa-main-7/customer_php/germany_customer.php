...
<body>
    ...
    <div class="tab-container">
        ...
        <div id="tourist" class="tabcontent active">
            <h2>Germany Tourist Visa Checklist</h2>
            <table>
                <tr>
        ...
        <div id="business" class="tabcontent">
            <h2>Germany Business Visa Checklist</h2>
            <table>
                <tr>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>Check list of Schengen countries: Austria, Belgium, Czech Republic, Croatia, Denmark, Estonia,
                        Finland, Germany, Germany, Greece, Hungary, Iceland, Italy, Latvia, Liechtenstein, Lithuania,

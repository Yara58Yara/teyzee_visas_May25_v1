...
<head>
    ...
    <title>Japan Visa Checklist</title>
...
<body>
    ...
    <h1>Japan Schengen Visa Checklist</h1>
    ...
    <div class="tab-container">
        ...
        <div id="tourist" class="tabcontent active">
            <h2>Japan Tourist Visa Checklist</h2>
            <table>
                <tr>
        ...
        <div id="business" class="tabcontent">
            <h2>Japan Business Visa Checklist</h2>
            <table>
                <tr>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>Check list of Schengen countries: Austria, Belgium, Czech Republic, Croatia, Denmark, Estonia,
                        Finland, Japan, Germany, Greece, Hungary, Iceland, Italy, Latvia, Liechtenstein, Lithuania,
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            downloadLinks.forEach(function (link) {
                link.addEventListener('click', function (e) {
                    ...
                    const message = `Kindly provide the latest ${templateName} for my visa application. In case you have not paid TeyZee Visa Fees, please make the visa service fees payment and get the receipt number. Link to Visa Fees Page for Japan - https://teyzee.com/Japan-visa-fees; please type the 7 digit receipt no in your next whatsapp message to us`;

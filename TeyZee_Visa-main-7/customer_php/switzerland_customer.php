...
<body>
    ...
    <div class="tab-container">
        ...
        <div id="tourist" class="tabcontent active">
            <h2>Switzerland Tourist Visa Checklist</h2>
            <table>
                <tr>
        ...
        <div id="business" class="tabcontent">
            <h2>Switzerland Business Visa Checklist</h2>
            <table>
                <tr>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>Check list of Schengen countries: Austria, Belgium, Czech Republic, Croatia, Denmark, Estonia,
                        Finland, Switzerland, Germany, Greece, Hungary, Iceland, Italy, Latvia, Liechtenstein, Lithuania,
        ...
        <div class="container">
            ...
            <div class="footer-countries">
                ...
                <div class="country-links">
                    ...
                    <a href="/html/Switzerland_customer.html">Switzerland</a> •
                    <a href="#">Russia</a> •
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            downloadLinks.forEach(function (link) {
                link.addEventListener('click', function (e) {
                    ...
                    const message = `Kindly provide the latest ${templateName} for my visa application. In case you have not paid TeyZee Visa Fees, please make the visa service fees payment and get the receipt number. Link to Visa Fees Page for Switzerland - https://teyzee.com/Switzerland-visa-fees; please type the 7 digit receipt no in your next whatsapp message to us`;
